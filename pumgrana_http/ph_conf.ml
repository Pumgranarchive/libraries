...
let research_contents_uri = content_uri ^ "search/"
let content_insert_uri = content_uri ^ "insert"
let content_delete_uri = content_uri ^ "delete"

let tag_uri = "tag/"
let research_tag_content_uri = tag_uri ^ "search/"
...
let research_linkedcontent_content_uri = linkedcontent_uri ^ "search/"
